...
import { ArrowRight, BookOpen, Briefcase, CheckCircle, Users, TrendingUp, Award } from "lucide-react"
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Find Your Perfect <span className="text-primary">Career Path</span>
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Career Compass helps you navigate your professional journey by recommending personalized work
                    opportunities or educational courses based on your unique profile.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Discover Your Path</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed">
                  Career Compass offers personalized recommendations in two key areas to help you make informed
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4 rounded-2xl bg-background p-6 shadow-lg border-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Discover job roles and career paths that align with your skills, experience, and aspirations. Get
                    insights into industries where you'll thrive.
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-center space-y-4 rounded-2xl bg-background p-6 shadow-lg  border-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Find courses, certifications, and learning paths that will enhance your skills and prepare you for
                    your desired career.
                  </p>
                </div>
                <ul className="grid gap-2">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed">
                  Our simple process helps you discover the best path for your future in just a few steps.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3">
              <div className="relative flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground">
                  Tell us about your education, skills, experience, and career aspirations.
                </p>
              </div>
              <div className="relative flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="absolute -top-3 -left-3 flex h-10 w-10 items-center justify-center rounded-full bg-primary text-primary-foreground">
                ...
                <p className="text-center text-muted-foreground">
                  Our algorithm analyzes your profile and provides personalized work and course recommendations.
                </p>
              </div>
              <div className="relative flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="absolute -top-3 -left-3 flex h-10 w-10 items-center justify-center rounded-full bg-primary text-primary-foreground">
                ...
                <p className="text-center text-muted-foreground">
                  Use our insights to make informed decisions about your next career or educational move.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed">
                  Hear from people who have transformed their careers with Career Compass.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col justify-between space-y-4 rounded-lg bg-background border-2 p-6 shadow-lg">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    "Career Compass helped me identify the perfect course to transition into data science. Six months
                    later, I landed my dream job!"
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-between space-y-4 rounded-lg bg-background border-2 p-6 shadow-lg">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    "I was stuck in a career I didn't enjoy. Career Compass showed me a path to UX design that matched
                    my creative skills. Best decision ever!"
                  </p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="h-10 w-10 rounded-full bg-primary/10"></div>
              ...
              <div className="flex flex-col justify-between space-y-4 rounded-lg bg-background border-2 p-6 shadow-lg md:col-span-2 lg:col-span-1">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    "As a recent graduate, I was overwhelmed by career options. Career Compass narrowed it down based on
                    my strengths and interests. Now I'm thriving in digital marketing!"
                  </p>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="h-10 w-10 rounded-full bg-primary/10"></div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-2 text-center">
              ...
              <Link href="/careertest">
                <Button size="lg" variant="secondary" className="mt-4 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 bg-[length:200%_200%] animate-border-gradient text-white">
                  Take Career Test
