...
export function CareerBanner() {
  return (
    ...
    <motion.div
      ...
      className="sm:w-3/4 sm:mx-auto md:w-1/2 mx-auto mt-2 p-[2px] rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 bg-[length:200%_200%] animate-border-gradient"
    >
